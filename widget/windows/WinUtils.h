...
enum tagAR_STATE_CUSTOM {
  AR_ENABLED_CUSTOM = 0x0,
  AR_DISABLED_CUSTOM = 0x1,
  AR_SUPPRESSED_CUSTOM = 0x2,
  AR_REMOTESESSION_CUSTOM = 0x4,
  AR_MULTIMON_CUSTOM = 0x8,
  AR_NOSENSOR_CUSTOM = 0x10,
  AR_NOT_SUPPORTED_CUSTOM = 0x20,
  AR_DOCKED_CUSTOM = 0x40,
  AR_LAPTOP_CUSTOM = 0x80
};

typedef enum tagAR_STATE_CUSTOM AR_STATE_CUSTOM;

using PAR_STATE_CUSTOM = enum tagAR_STATE_CUSTOM*;
